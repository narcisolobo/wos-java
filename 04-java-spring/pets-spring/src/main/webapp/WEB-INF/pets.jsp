...
<main class="container">
  <h1 class="display-4 mb-3">Welcome, ${user.firstName} ${user.lastName}!</h1>
  <table class="table">
    <thead>
      <tr>
        <th>Name</th>
      ...
      <c:forEach var="pet" items="${pets}">
        <tr>
          ...
          <td class="d-flex gap-2 align-items-center">
            <a class="btn btn-sm btn-primary" href="/pets/${pet.id}">View</a>
            <c:if test="${user == pet.user}">
              <a class="btn btn-sm btn-warning" href="/pets/${pet.id}/edit">Edit</a>
